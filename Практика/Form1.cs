...
namespace Практика
{
    public partial class Form1 : Form
    {
        ...
        private void файлыToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            Form23 fr23 = new Form23();
            fr23.Show();
            this.Hide();
        }

        private void прикладныеЗадачиToolStripMenuItem_Click(object sender, EventArgs e)
        {
